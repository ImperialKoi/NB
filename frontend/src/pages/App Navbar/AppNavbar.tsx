        ...
        <div className="bg-white border-b border-3 border-[#DCDCDC]">
            <div className="container mx-auto px-4 py-4 flex justify-center items-center space-x-8">
                ...
                <div className="flex space-x-6">
                    ...
                    <Link to="/learn" className="flex flex-col items-center group">
                        <img src={SaveIcon} alt="Profile" className="w-6 h-6" />
                        <span className={`text-sm mt-1 ${location.pathname === '/learn' ? 'text-black' : 'text-gray-500'} relative group-hover:text-black`}>
                            Learn
                            <span className={`absolute left-0 bottom-0 h-[1px] w-full bg-black transform ${location.pathname === '/learn' ? 'scale-x-100' : 'scale-x-0'} group-hover:scale-x-100 transition-transform duration-300 origin-left`}></span>
                        </span>
                    </Link>
                </div>
            </div>
